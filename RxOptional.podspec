...
Pod::Spec.new do |s|
  ...
  s.dependency 'RxSwift', :git 'https://github.com/ReactiveX/RxSwift.git', :branch 'swift-3.0'
  s.dependency 'RxCocoa', :git 'https://github.com/ReactiveX/RxSwift.git', :branch 'swift-3.0'
